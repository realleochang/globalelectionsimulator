  ...
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" className="shrink-0" aria-hidden="true">
      <defs>
        ...
        <radialGradient id="usa-logo-shine" cx="38%" cy="32%" r="62%">
          <stop offset="0%" stopColor="white" stopOpacity="0.38" />
          <stop offset="100%" stopColor="black" stopOpacity="0.22" />
        </radialGradient>
      </defs>
      <g clipPath="url(#usa-logo-clip)">
      ...
      <g clipPath="url(#usa-logo-clip)" stroke="white" strokeWidth="0.7" strokeOpacity="0.55" fill="none">
      ...
      <g clipPath="url(#usa-logo-clip)" stroke="white" strokeWidth="0.6" strokeOpacity="0.22" strokeDasharray="1.5 1.5" fill="none">
      ...
      <g clipPath="url(#usa-logo-clip)" stroke="white" strokeWidth="0.65" strokeOpacity="0.30" fill="none">
      ...
      <header className={`h-[52px] ${dark ? 'bg-[rgba(7,13,28,0.94)]' : 'bg-[rgba(245,244,240,0.92)]'} backdrop-blur-xl border-b border-default shadow-header shrink-0 flex items-center z-50`}>
        ...
        <button onClick={() => navigate('/')} className="flex items-center gap-2.5 hover:opacity-80 transition-opacity cursor-pointer shrink-0 pl-4" title="Home">
          ...
          <div className="hidden sm:flex flex-col justify-center mr-2 leading-none">
            <span className="font-title text-[13px] font-bold uppercase tracking-widest text-ink leading-none">Global Election Simulator</span>
